...
public class FlightAmends extends AbstractComponents {
	...
	public FlightAmends(WebDriver driver) 
	{
		super(driver);
		this.driver = driver;
	...
	public static void FlightAmendments(String baggage, String sportsSSR, String petSSR) throws InterruptedException
	{
		Baggage = baggage;
		SportSSR = sportsSSR;
		PetSSR = petSSR;
